...
large_file_path = "data/lesson_rag/huge_file.txt"
...
if os.path.exists(large_file_path):
    ...
    for block in blocks:
        ...
        file_name = os.path.basename(large_file_path)  # Імя файлу без шляху
        key_name = file_name + " | " + block_title  # Імя файлу та заголовок
        id_data[key_name] = new_id  # Додаємо в Дікт ID по ключу
