...
def doc_ser(user_text: str):
    """
   Функція пошуку документів в векторній базі даних за запитом користувача.

    :param user_text: Запит користувача
    :return: Список документів (Document), які найбільше підходять за запитом користувача.
    """
